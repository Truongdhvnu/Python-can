...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target=CanTpCN.canTp_Transmit, args=(node1, 0x111, pduInforMapping[0x111]))
    t1.start()

    time.sleep(2)

    t2 = threading.Thread(target=CanTpCN.canTp_Transmit, args=(node1, 0x222, pduInforMapping[0x222]))
    t2.start()
