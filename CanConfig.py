...
pduConfigMapping : Dict[int, PduIdConfig] = {0x111:PduIdConfig(BS=3, ST_min=10, is_fd=False), 0x222:PduIdConfig(BS=4, ST_min=10, is_fd=False, WFTmax=2), 0x333:PduIdConfig(BS=5, is_fd=True)}
